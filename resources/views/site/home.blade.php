            ...
            <div class="relative">
                ...
                <div class="relative aspect-[4/5] border-2 border-ink bg-bone sticker-shadow overflow-hidden">
                    @if(!empty($site['hero_image']))
                        <x-site.img :src="$site['hero_image']" alt="" sizes="(min-width: 1280px) 400px, (min-width: 1024px) 30vw, (min-width: 640px) 60vw, 92vw" loading="eager" class="h-full w-full object-cover"/>
                    @else
                    ...
                    <div class="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                        <div class="relative {{ $i % 2 === 1 ? 'lg:order-2' : '' }}">
                            ...
                            <div class="relative aspect-[4/3] border-2 border-ink bg-bone sticker-shadow overflow-hidden">
                                @if(!empty($cat['image']))
                                    <x-site.img :src="$cat['image']" :alt="$cat['title']" sizes="(min-width: 1280px) 600px, (min-width: 1024px) 45vw, 92vw" class="h-full w-full object-cover"/>
                                @else
                                    <div class="h-full w-full halftone-fire flex items-center justify-center">
        ...
        <div class="mx-auto max-w-7xl px-4 md:px-6 py-20 md:py-28 grid lg:grid-cols-2 gap-12 items-center">
            <div class="relative">
                ...
                <div class="relative aspect-[4/5] border-2 border-ink bg-fire overflow-hidden">
                    <x-site.img :src="$site['our_story_image'] ?? null" fallback="our-story-feat.jpg" :alt="__('Our story')" sizes="(min-width: 1280px) 600px, (min-width: 1024px) 45vw, 92vw" class="h-full w-full object-cover"/>
                </div>
            </div>
            <div>
