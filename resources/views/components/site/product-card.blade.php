...
<a href="{{ route('products.show', $product->slug) }}"
   class="group relative flex h-full flex-col brush-card bg-bone text-ink p-3 transition">
    <div class="relative shrink-0 aspect-square overflow-hidden border-2 border-ink/80 bg-bone-dark">
        @if($primary)
            <x-site.img :src="$primary" :alt="$product->t('title')" sizes="(min-width: 1280px) 300px, (min-width: 768px) 30vw, (min-width: 640px) 65vw, 80vw" :widths="[320, 480, 640, 768, 1024]"
            ...
            @if($hover)
                <x-site.img :src="$hover" alt="" aria-hidden="true" sizes="(min-width: 1280px) 300px, (min-width: 768px) 30vw, (min-width: 640px) 65vw, 80vw" :widths="[320, 480, 640, 768, 1024]"
