...
class UpdateSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'hero_subheading_el' => ['nullable', 'string', 'max:500'],
            'hero_cta_text_el' => ['nullable', 'string', 'max:64'],
            'announcement_messages_el' => ['nullable', 'string', 'max:2000'],
            'hero_image' => ['nullable', 'image', 'max:8192'],
            'lineup_chews_image' => ['nullable', 'image', 'max:8192'],
            'lineup_treats_image' => ['nullable', 'image', 'max:8192'],
            'our_story_image' => ['nullable', 'image', 'max:8192'],
            ...
            'contests_page_status' => ['nullable', 'in:draft,public'],
            'contest_notify_email' => ['nullable', 'email', 'max:255'],
